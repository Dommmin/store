...
export default function Register() {
   ...
   return (
      <div className="flex items-center justify-center min-h-screen max-w-lg mx-auto">
         <div className="flex flex-col items-center justify-center w-full space-y-4 card bg-white dark:bg-gray-800 glass shadow-xl py-6">
            <form className="w-full max-w-md" onSubmit={submitForm}>
               <h1 className="font-bold text-3xl text-black dark:text-gray-200 text-center">Register new account</h1>
               <div className="space-y-4 py-6">
                   <div>
                       <label className="input-custom flex items-center gap-2">
                           <svg
                ...
                <div className="text-center space-x-1 pt-2">
                    ...
                    <Link className="link link-hover text-success font-bold tracking-wide" href="/login">
                        Login
                    </Link>
                </div>
            </form>
