      ...
      <div className="w-full max-w-xl space-y-4">
         <div className="flex space-x-4">
            <div className="w-full">
               <input
                  ...
                  className={'input input-bordered w-full max-w-xs ' + (props.errors.firstName ? 'input-error' : '')}
                  type="text"
            ...
            <div className="w-full">
               <input
                  ...
                  className={'input input-bordered w-full max-w-xs ' + (props.errors.lastName ? 'input-error' : '')}
                  type="text"
         ...
         <div>
            <input
               ...
               value={props.address}
               className={'input input-bordered w-full max-w-xl ' + (props.errors.address ? 'input-error' : '')}
               type="text"
               placeholder="Address"
         ...
         <div className="grid w-full max-w-xl grid-cols-3 gap-4">
            <div className="col-span-1">
               <input
                  ...
                  value={props.zipCode}
                  className={'input input-bordered w-full max-w-xs ' + (props.errors.zipCode ? 'input-error' : '')}
                  type="text"
            ...
            <div className="col-span-2">
               <input
                  ...
                  value={props.city}
                  className={'input input-bordered w-full max-w-xs ' + (props.errors.city ? 'input-error' : '')}
                  type="text"
                  placeholder="City"
