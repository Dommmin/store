...
export default function Orders() {
   const [url, setUrl] = useState('/api/v1/admin/orders');
   ...
   const handleDelete = async (id: number) => {
      try {
         const response = await axios.delete(`/api/v1/admin/orders/${id}`);
   ...
   return (
      <>
         <h1 className="p-2 text-3xl font-bold">Orders</h1>
         <div className="mx-auto flex max-w-6xl justify-end p-2 sm:px-6 lg:px-8">
            <Link href={'/admin/brands/create'} className="btn btn-success btn-wide text-white">
               Create Order
            </Link>
         </div>
