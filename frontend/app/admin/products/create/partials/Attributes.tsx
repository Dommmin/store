import { Attribute, AttributeValue, Product, SelectedAttribute } from '../../../../types/product';
...
interface Props {
   ...
   addAttribute: () => void;
   updateAttribute: (index: number, attribute: string) => void;
   ...
   return (
      <div>
         <div className="mb-4 flex justify-end">
            <button type="button" onClick={props.addAttribute} className="btn btn-info btn-sm w-full text-white">
               Add attribute
            </button>
         </div>
               ...
               <div className="flex space-x-2 lg:space-x-4" key={index}>
                  ...
                  {selected.attribute && (
                     ...
                     >
                        ...
                        {/*   props.attributeValues[index].values.map((value: AttributeValue) => (*/}
