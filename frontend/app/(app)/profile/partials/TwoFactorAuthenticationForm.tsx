...
export default function TwoFactorAuthenticationForm({ className = '', user }) {
   ...
   // if (!user.two_factor_confirmed_at && !enabling && !confirming && !postConfirming) {
   //     axios
      ...
      <section className={className}>
         <header>
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">
               {!user.two_factor_confirmed_at && !confirming && 'You have not enabled two factor authentication.'}
               {!user.two_factor_confirmed_at && confirming && 'Finish enabling two factor authentication.'}
               {user.two_factor_confirmed_at && 'You have enabled two factor authentication.'}
            </h2>
         ...
         {user?.two_factor_confirmed_at && recoveryCodes.length > 0 && !confirming && (
            <div>
               <div className="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                  <p className="font-semibold">
         ...
         <div className="mt-5">
            {!user.two_factor_confirmed_at && !enabling && !confirming && !postConfirming ? (
