...
const ProductPage: React.FC<{ params: { url: string } }> = ({ params }) => {
            ...
            <Wrapper>
               <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
                  <div className="relative lg:col-span-2">
                     ...
                     <div className="mt-4 flex w-full justify-between space-x-2 overflow-x-auto">
                              ...
                              <div className="flex space-x-2">
                                 {associations.map((item: Association) => (
                                    <div key={item.id}>
                                       ...
                                       <p>
                                          {item.variant.attributes.find((attribute) => attribute.name === key)?.value}
                                       </p>
                                    </div>
                                 ))}
                              </div>
