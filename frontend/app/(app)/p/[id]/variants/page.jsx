            ...
            <div className="space-y-4">
                {variants.map((variant) => (
                    <div
                        ...
                        key={variant.id}
                    >
                        <Link href={'/p/' + variant.id} className="flex flex-col sm:flex-row space-x-0 space-y-2 sm:space-x-4 sm:space-y-0 p-4">
                            <Image className="rounded-lg w-full sm:w-1/4" layout="cover" src={variant.main_image} alt={variant.name} width={400} height={400} />
                            <div>
                                <p>{variant.name}</p>
                                <div>
